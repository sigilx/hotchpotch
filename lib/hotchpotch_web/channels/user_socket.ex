defmodule HotchpotchWeb.UserSocket do
  ...
  ## Channels
  channel "board:chat:*", HotchpotchWeb.BoardchatChannel
  channel "board:draw:*", HotchpotchWeb.BoarddrawChannel
  ...
  #
  #     Hotchpotch.Endpoint.broadcast("users_socket:#{user.id}", "disconnect", %{})
  #
